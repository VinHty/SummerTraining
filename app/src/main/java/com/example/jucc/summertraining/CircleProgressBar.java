...
/**
 * Created by xiaoqiang on 2016/7/16.
 */
...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //进度开始的角度数
        startAngle = mTypedArray.getInt(R.styleable.CircleProgressBar_startAngle, -90);
        // 圆形颜色
        backColor = mTypedArray.getColor(R.styleable.CircleProgressBar_backColor, 0);
        mTypedArray.recycle();
    }
