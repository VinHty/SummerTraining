 ...
 * {@link AchievementBigFishFragment.OnFragmentInteractionListener} interface
...
public class AchievementBigFishFragment extends ListFragment {
    ...
    public AchievementBigFishFragment() {
     ...
     * @return A new instance of fragment AchievementBigFishFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static AchievementBigFishFragment newInstance(String param1, String param2) {
        AchievementBigFishFragment fragment = new AchievementBigFishFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_achievement_big_fish, container, false);
    }
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.fragment_achievement_big_fish_listview,null);
                holder.leftimagerview = (ImageView) convertView.findViewById(R.id.bigfish_leftimageview);
                holder.leftfishname = (TextView) convertView.findViewById(R.id.bigfish_leftname);
                holder.leftfishamount = (TextView) convertView.findViewById(R.id.bigfish_lefttextview);
                holder.rightimageview = (ImageView)convertView.findViewById(R.id.bigfish_rightimageview);
                holder.rightfishname = (TextView)convertView.findViewById(R.id.bigfish_rightname);
                holder.rightfishamount = (TextView)convertView.findViewById(R.id.bigfish_righttextview);
